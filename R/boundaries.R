...
st_write(huc8,"data_out/huc8.gpkg")
...
st_write(st,"data_out/st.gpkg",overwrite=TRUE)
...
st_write(places,"data_out/places.gpkg")
...
st_write(county,"data_out/county.gpkg")
...
#county$uri <- paste0(root,"county/",places$GEOID)
st_write(congress,"data_out/congress.gpkg")
...
#county$uri <- paste0(root,"county/",places$GEOID)
st_write(house,"data_out/sthouse.gpkg")
...
#county$uri <- paste0(root,"county/",places$GEOID)
st_write(senate,"data_out/senate.gpkg")
