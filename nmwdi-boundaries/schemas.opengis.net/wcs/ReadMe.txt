...
More information on the OGC WCS standard may be found at
 http://www.ogc.org/standards/wcs

The most current schema are available at http://schemas.opengis.net/ .

-----------------------------------------------------------------------

2020-08-14  Peter Baumann
  * wcs/processing/2.1: Add WCS Processing Extension 2.1.0 as 2.1 (OGC 19-033r2)

2020-08-07  Peter Baumann
  * wcs/2.1: Update WCS 2.1.0 as wcs/2.1 per corrigenda OGC 19-033r2
	+ wcsCommon.xsd schema fix to adjust pattern to allow 2.x.x,
  * wcs/crs/1.1: Add WCS CRS Extension 1.1.0 as 1.1 (OGC 19-033r2)
  * wcs/scaling/1.1: Add WCS Scaling Extension 1.1.0 as 1.1 (OGC 19-033r2)
  * wcs/transaction/2.0: Update WCS Transaction Extension 2.0 examples (OGC 19-033r2)
  * wcs/transaction/2.1: Add WCS Transaction Extension 2.1.0 as 2.1 (OGC 19-033r2)
    + Add missing CoverageId element to DescribeCoverage schema (P. Trevelyan)
    + Update examples

2020-03-19  Peter Baumann
  * wcs/2.0: Update WCS 2.0.2 as wcs/2.0 per corrigenda OGC 19-033r2
	+ wcsCommon.xsd schema fix to adjust pattern to allow 2.x.x,
      (needed for 2.1). (reported by P Trevelyan)
  * wcs/2.1: Update WCS 2.1.0 as wcs/2.1 per corrigenda OGC 19-033r2
	+ wcsCommon.xsd schema fix to adjust pattern to allow 2.x.x,
  * wcs/crs/1.0: Update WCS CRS Extension 1.0.0 as 1.0 (OGC 19-033r2)
  * wcs/transaction/2.0: Update WCS Transaction Extension 2.0 examples (OGC 19-033r2)

2016-12-23  Peter Baumann
  * wcs/interpolation/1.1: added WCS 2.1 Interpolation Extension 1.1.0 (OGC 12-049r1)
...
Policies, Procedures, Terms, and Conditions of OGC(r) are available
  http://www.ogc.org/ogc/legal/ .

Copyright (c) 2010, 2014, 2020 Open Geospatial Consortium
